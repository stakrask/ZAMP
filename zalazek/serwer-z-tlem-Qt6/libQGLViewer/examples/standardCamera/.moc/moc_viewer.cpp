...
template <> constexpr inline auto Viewer::qt_create_metaobjectdata<qt_meta_tag_ZN6ViewerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Viewer, qt_meta_tag_ZN6ViewerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Viewer::staticMetaObject = { {
    QMetaObject::SuperData::link<QGLViewer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6ViewerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6ViewerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6ViewerE_t>.metaTypes,
    nullptr
} };
...
void Viewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Viewer::*)()>(_a, &Viewer::cameraChanged, 0))
            return;
    }
}
...
void *Viewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6ViewerE_t>.strings))
