...
namespace {
struct qt_meta_tag_ZN3gsv17MainWindow4ServerE_t {};
} // unnamed namespace

template <> constexpr inline auto gsv::MainWindow4Server::qt_create_metaobjectdata<qt_meta_tag_ZN3gsv17MainWindow4ServerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<MainWindow4Server, qt_meta_tag_ZN3gsv17MainWindow4ServerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject gsv::MainWindow4Server::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3gsv17MainWindow4ServerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3gsv17MainWindow4ServerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN3gsv17MainWindow4ServerE_t>.metaTypes,
    nullptr
} };
...
void *gsv::MainWindow4Server::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3gsv17MainWindow4ServerE_t>.strings))
